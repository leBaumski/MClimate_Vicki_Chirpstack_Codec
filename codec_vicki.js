...
//Main caller for Chirpstack App Server
function decodeUplink(input){
    ...
    if (payload[0].toString(16) == 1 || payload[0].toString(16) == 129) {
        data = merge_obj(data, handleKeepalive(payload, data));
      	return {data};
    }else{
        data = merge_obj(data, handleResponse(payload, data));
...
//For development and testing; remove before including into chirpstack
